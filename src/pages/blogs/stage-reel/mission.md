...
1. **Arrêt** : Isoler totalement l'équipement.
2. **Manuel** : Pilotage via boîte à boutons pour des mouvements unitaires.
3. **Maintenance** : Accès restreint pour les interventions techniques.
4. **Automatique** : Cycles de nettoyage déclenchés par perte de charge (>0,1 mCE).
5. **Marche forcée** : Nettoyage continu en cas de pollution massive du fleuve.
